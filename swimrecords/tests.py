...
class SwimRecordTestCase(TestCase):
    ...
    def test_04_validate_relay_presence(self):
        ...
        try:
            ...
            # print(str(e.message_dict['relay'][0])=='“None” value must be either True or False.')
            # print(str(e.message_dict['relay'][0]))
            # print('"None" value must be either True or False.')
    ...
    def test_05_valid_stroke(self):
        ...
        try:
            ...
            self.assertTrue("Value 'doggie paddle' is not a valid choice." in e.message_dict['stroke'])
