...
class SwimRecordTestCase(TestCase):
  ...
  def test_validate_first_name_presence(self):
  ...
  def test_validate_last_name_presence(self):  
  ...
  def test_validate_team_name_presence(self):
  ...
  def test_validate_relay_presence(self):
  ...
  def test_no_future_records(self):
  ...
  def test_no_break_record_before_set_record(self):
